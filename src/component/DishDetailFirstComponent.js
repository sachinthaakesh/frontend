...
import { Control, LocalForm } from 'react-redux-form';
    ...
    function RenderDish ({dish, postFavorite}){
        return(
    ...
    function DishDetailFirst(props){
        ...
        return (
            ...
            <div className="row">
                <div className="col-12 col-md-5 m-1">
                <RenderDish dish={props.dish} postFavorite={props.postFavorite} />
    ...
    export default DishDetailFirst;
    //<RenderComments comments={props.comments} />