...
export const signupUser = (firstname,lastname,username,password) => (dispatch) => {
    // We dispatch requestLogin to kickoff the call to the API
    //dispatch(requestSignup(firstname,lastname,username,password))
    const creds = {
        firstname: firstname,
        lastname: lastname,
        username: username,
...
export const postFavorite1 = () => (dispatch) => {

    const bearer = 'Bearer ' + localStorage.getItem('token');

    return fetch(baseUrl + 'favorites/', {
        method: "POST",
        body: JSON.stringify({"_id": '614a50c327702e1ae4028aaf'}),
        headers: {
          "Content-Type": "application/json",
          'Authorization': bearer
        },
